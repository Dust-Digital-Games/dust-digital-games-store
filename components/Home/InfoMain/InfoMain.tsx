  ...
  return (
    <main className="pt-40 dark:bg-bgDarkMode ">
      <div className=" flex flex-col justify-center items-center gap-4  dark:bg-bgDarkMode">
        ...
        <p className="text-center mx-9 font-semibold mt-2 dark:text-white font-inter ">
          In Dust Games, every game is an NFT that can be traded in Opensea
          through game collections.
        </p>
      </div>
      <button className="pt-10 text-primary font-bold mx-auto w-full cursor-pointer dark:text-white font-inter ">
      ...
      <div className="flex justify-center items-center flex-col py-24">
        <IconMetamask />
        <h2 className="font-semibold dark:text-white font-inter ">
          Powered with{" "}
          <span className="font-bold text-xl dark:text-white font-inter ">
            Metamask
          </span>
        </h2>
      </div>
